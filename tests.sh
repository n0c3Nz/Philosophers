...
random_commands=(
    ...
    "./Philosophers 50 400 201 200 20 | grep 'died' -A3"
	"./Philosophers 50 900 450 451 20 | grep 'died' -A3"
)
moreat_commands=(
	"./Philosophers 7 800 502 300 | grep 'died' -A3"
	"./Philosophers 19 300 152 150 | grep 'died' -A3"
	"./Philosophers 13 800 501 301 | grep 'died' -A3"
	"./Philosophers 20 800 501 301 | grep 'died' -A3"
	"./Philosophers 5 800 501 300 | grep 'died' -A3"
	"./Philosophers 2 300 202 99 | grep 'died' -A3"
	"./Philosophers 60 400 301 100 | grep 'died' -A3"
	"./Philosophers 33 500 401 100 | grep 'died' -A3"
)
moresleep_commands=(
	"./Philosophers 6 800 300 501 | grep 'died' -A3"
	"./Philosophers 5 700 200 501 | grep 'died' -A3"
	"./Philosophers 23 500 99 402 | grep 'died' -A3"
	"./Philosophers 60 900 200 701 | grep 'died' -A3"
	"./Philosophers 71 900 100 802 | grep 'died' -A3"
	"./Philosophers 113 500 200 301 | grep 'died' -A3"
	"./Philosophers 100 800 400 401 | grep 'died' -A3"
	"./Philosophers 100 700 201 500 | grep 'died' -A3"
)
